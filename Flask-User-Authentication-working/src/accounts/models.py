...
class UserAccountTable(UserMixin, db.Model):
    ...
    def __init__(self, email, password, tokenGenerationTime, emailVerificationStatus, emailVerifiedTime, passwordRecoveryToken, recoveryTokenTime, roleType, is_admin):
        self.email=email
